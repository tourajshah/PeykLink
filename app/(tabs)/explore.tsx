...
export default function Index() {
  ...
  const recommendedRequests = useQuery(api.trips.getRecommendedRequests)
  ...
  if (trips === undefined || recommendedRequests === undefined) return <Loader />;

  type TripType = (typeof trips)[number];
  type RequestType = (typeof recommendedRequests)[number];
  ...
  const filteredRequests = recommendedRequests.filter(request =>
